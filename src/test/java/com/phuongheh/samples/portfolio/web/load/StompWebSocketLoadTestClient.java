...
public class StompWebSocketLoadTestClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            StopWatch stopWatch = new StopWatch("STOMP Borker Relay WebSocket Load Tests");
            stopWatch.start();
            ...
            logger.debug("Broadcasting " + BROADCAST_MESSAGE_COUNT + " messages to " + NUMBER_OF_USERS);
            stopWatch.start();
    ...
    private static class ProducerStompSessionHandler extends StompSessionHandlerAdapter {
        ...
        public ProducerStompSessionHandler(int numberOfMessagesToBroadcast,
        ...
        public void afterConnected(StompSession session, StompHeaders connectedHeaders) {
            ...
            try {
                ...
                logger.error("Message sending failure at " + i, t);
                failure.set(t);
            }
        }
